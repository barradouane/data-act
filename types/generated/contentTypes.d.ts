...
export interface ApiDataActDataAct extends Struct.CollectionTypeSchema {
  collectionName: 'data_acts';
  info: {
    displayName: 'data-act';
    pluralName: 'data-acts';
    singularName: 'data-act';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    countries: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    obligations: Schema.Attribute.Boolean & Schema.Attribute.Required;
    opportunity: Schema.Attribute.Boolean & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
